			...
			<div class="container">
				...
				<div class="nav-collapse navbar-responsive-collapse">
					<ul class="nav navbar-nav">
						...
						<li><a href="productupdate">EDIT PRODUCT</a></li>
						<li><a href="signout">SIGNOUT<span
...
<div class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
        <img class="img-responsive" src="resources/images/FHD2.jpg"/></div>
        <div class="item">
  ...
  <div class="item">
        <img class="img-responsive" src="resources/images/FHD6.jpg"/>
        </div>
    </div>
</div>

...
<div class="container" id="main">
		...
		<!-- 		<a class="navbar-brand" href="/"> 
						<img
					src="images/site_logo.png" onclick="index.jsp" align="top"
